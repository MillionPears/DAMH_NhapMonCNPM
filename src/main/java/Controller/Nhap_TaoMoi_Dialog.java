...
import static Controller.Nhap_ThemVao_Dialog.addressExcel;
import Other.*;
 ...
 * @author trieu
 */
public class Nhap_TaoMoi_Dialog extends javax.swing.JDialog {
    ...
    public Nhap_TaoMoi_Dialog(java.awt.Frame parent, boolean modal, String mapn, Nhaphang nhaphang) {
        super(parent, modal);
        initComponents();
        mapn_tmp = mapn;
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(cbbDS_Soseri, javax.swing.GroupLayout.PREFERRED_SIZE, 271, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btnNhapFileActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapFileActionPerformed
        ...
        try {
            ...
            System.out.println("217- Nhap_taomoi");
        }
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        boolean add_tb;
        if (txtTenTB.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Tên thiết bị đang để trống!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            txtTenTB.requestFocus();
        } else if (txtIDTB.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "ID thiết bị đang để trống!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            txtIDTB.requestFocus();
        } else if (!check.isText(txtIDTB.getText())) {
            JOptionPane.showMessageDialog(null, "ID thiết bị không được chứa ksi tự khác ngoài chữ!", "Lỗi", JOptionPane.ERROR_MESSAGE);
            txtIDTB.requestFocus();
        } else if (txtIDTB.getText().length() > 10) {
            JOptionPane.showMessageDialog(null, "Lưu ý Chỉ lấy 10 kí tự đầu tiên để lưu làm ID THIẾT BỊ!", "Thông báo", JOptionPane.OK_OPTION);
            txtIDTB.setText(check.Lay_10Kitu(txtIDTB.getText()));
        } else if (!check.isNumber(txtSoLuong.getText())) {
            ...
            if (soluong_seri == 0) {
                ...
                if (flag == 0) {
                    ...
                    if (input == JOptionPane.YES_OPTION) {
                        if (!dao.Check_ID_Trung(txtIDTB.getText())) {
                            JOptionPane.showMessageDialog(null, "ID thiết bị đã bị trùng!\n Vui lòng nhập lại", "Lỗi", JOptionPane.ERROR_MESSAGE);
                            txtIDTB.requestFocus();
                        } else if (!dao.Check_tenTB_Trung(txtTenTB.getText())) {
                            JOptionPane.showMessageDialog(null, "Tên thiết bị đã tồn tại trước đó!\n Vui lòng nhập lại", "Lỗi", JOptionPane.ERROR_MESSAGE);
                            txtTenTB.requestFocus();
                        } else {
                            txtTenTB.setText(check.formatName(txtTenTB.getText()));
                            txtTenTB.setText(txtTenTB.getText().toUpperCase());
...
//                        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Nhap_TaoMoi_Dialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                Nhap_TaoMoi_Dialog dialog = new Nhap_TaoMoi_Dialog(new javax.swing.JFrame(), true);
